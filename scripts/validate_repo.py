...
required = [
 ...
 'examples/education/shadow_ai_habit_to_curriculum_debugging_example.json',
 ...
 'docs/rendered/shadow_ai_habit_to_curriculum_debugging_example.md',
...
commands = [
 ...
 ['python3','tools/shadow-ai-amnesty-triage-sheet/render_sheet.py','examples/education/shadow_ai_habit_to_curriculum_debugging_example.json'],
